...
class BorderRadiusCSS extends _BorderRadiusCSSBase {
  ...
  const BorderRadiusCSS.horizontal({
    SizeCSS left = SizeCSS.zero,
    SizeCSS right = SizeCSS.zero,
  }) : super(left, right, left, right);

  const BorderRadiusCSS.vertical({
    SizeCSS top = SizeCSS.zero,
    SizeCSS bottom = SizeCSS.zero,
