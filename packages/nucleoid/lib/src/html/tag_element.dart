...
class Document extends ChildNodeElement {
  Document({NodeElement? child, List<NodeElement>? children})
...
abstract class HtmlBuilt
    implements BuiltNodeElement<ChildNodeElement>, NoEvents {
...
abstract class MainBuilt
    implements BuiltNodeElement<ChildNodeElement>, NoEvents {}

abstract class AsideBuilt
    implements BuiltNodeElement<ChildNodeElement>, NoEvents {}
