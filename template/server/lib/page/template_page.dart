...
abstract class TemplatePage extends BuildResponse with Loggable {
  final String _title;
    ...
    return Response(
      ...
      body: Html(
        ...
        children: [
          ...
          Body(children: <NodeElement>[
            Div(id: 'content', children: [
              Div(
                children: [
                  A(
                    child: Img(src: '${Routes.imagesPath.url}vkontakte.svg'),
              ...
              if (title != null && title.isNotEmpty) H1(child: Text(title)),
              ...?content(),
            ]),
          ]),
        ],
